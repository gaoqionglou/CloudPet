package com.app.cloudpet.widget;
...
import com.app.cloudpet.utils.UiUtil;
...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    private ImageView mIConAdd = null;
...
//                final AppCompatImageView deleteImageView = (AppCompatImageView) v;
    ...
    private void initAddIcon() {
        mIConAdd = new ImageView(getContext());
        mIConAdd.setImageResource(R.drawable.ic_add_black_50dp);
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mIConAdd.getLayoutParams();
        layoutParams = new LinearLayout.LayoutParams(UiUtil.dip2px(getContext(), 2000), UiUtil.dip2px(getContext(), 200));
        mIConAdd.setLayoutParams(layoutParams);
        mIConAdd.setScaleType(ImageView.ScaleType.FIT_XY);
